...
namespace CSharpFunctionalExtensions
{
    public static class ResultExt
    {
        ...
        */
        ...
        public static Result<TResult> Then<T, TResult>
            (this Result<T> result, Func<T, Result<TResult>> f)
            => result.Match(
        ...
        */
        ...
        public static TResult Match<T, TResult>(this Result<T> result, Func<T, TResult> func, Func<Error, TResult> fail)
        {
            return result.IsFailure 
                ? fail(result.Error) 
                : func(result.Value);
